    ...
    <div id="wrapper" class="toggled">
        ...
        <div id="sidebar-wrapper" class="bg-2">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a class="active" href="medium-risk.php"><i class="fa-solid fa-gauge"></i> Medium Risk</a>
                </li>
                <li>
            ...
            <div class="container-fluid">
                ...
                <div class="sub-heading title-ul">
                    ...
                    <ol class="breadcrumb bg-transparent w-50 m-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Medium Risk Vulnerabilities</li>
                    </ol>
                </div>

                <div>
                    <div class="card bg-2-border text-white mt-3">
                        <div class="card-body" style="border-width: 1rem; border-bottom: solid #f0ad4e; border-bottom-left-radius: 1%; border-bottom-right-radius: 1%;">Current total medium risk:
                            <?php
                ...
                <table class="my-table mt-4">
                    ...
                    <?php
                        ...
                        $select = "(SELECT * FROM risk_assessment WHERE teamId = '$teamcode' AND NOT teamId = '' AND risk='Medium') UNION (SELECT * FROM risk_assessment WHERE risk_owner = '$username' AND risk='Medium')";
