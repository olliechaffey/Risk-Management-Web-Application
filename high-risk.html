    ...
    <div id="wrapper" class="toggled">
        ...
        <div id="sidebar-wrapper" class="bg-2">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a class="active" href="high-risk.php"><i class="fa-solid fa-gauge-high"></i> High Risk</a>
                </li>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <h1 class="heading">High Risk Vulnerabilities</h1>
                ...
                <div class="sub-heading title-ul">
                    ...
                    <ol class="breadcrumb bg-transparent w-50 m-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">High Risk Vulnerabilities</li>
                    </ol>
                </div>

                <div>
                    <div class="card bg-2-border text-white mt-3">
                        <div class="card-body" style="border-width: 1rem; border-bottom: solid #d9534f; border-bottom-left-radius: 1%; border-bottom-right-radius: 1%;">Current total high risk:
                            <?php
                ...
                <table class="my-table mt-4">
                    ...
                    <?php
                        ...
                        $select = "(SELECT * FROM risk_assessment WHERE teamId = '$teamcode' AND NOT teamId = '' AND risk IN('Very High', 'High', 'Extreme')) UNION (SELECT * FROM risk_assessment WHERE risk_owner = '$username' AND risk IN('Very High', 'High', 'Extreme'))";
